package br.com.makersweb.makersnews.common.model;
...
public enum ProblemType {
    ...
    ENTITY_IN_USE("/entity-in-use", "Entidade em uso", HttpStatus.PROCESSING),
    ...
    ProblemType(String path, String title, HttpStatus status) {
        this.uri = "https://auth.alganews.com.br" + path;
        this.title = title;
        this.status = status;
    }
